  ...
  render() {
    return (
      <NavLink to={this.props.route ? this.props.route : '/'} onClick={this.props.onClick}
        ...
        <li className='sidebar__link align-items-center'>
          {this.props.icon ? <span className={`sidebar__link-icon lnr lnr-${this.props.icon}`}><img src={`/Icons/${this.props.icon}.png`} /></span>: ''}
